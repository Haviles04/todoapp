...
function OptionsFooter(props) {
  ...
  return (
    <div className="completedActiveOptions">
      ...
      <div className={`options options_${props.theme}`}>
        <form>
          <input
            id="all"
            type="radio"
            ...
            defaultChecked
          />
          <label className={`todoStatusLabel todoStatusLabel_${props.theme}`} htmlFor="all">
            All
          </label>
          <input
            id="active"
          ...
          />
          <label className={`todoStatusLabel todoStatusLabel_${props.theme}`} htmlFor="active">
            Active
          </label>
          <input
            id="completed"
          ...
          />
          <label className={`todoStatusLabel todoStatusLabel_${props.theme}`} htmlFor="completed">
            Completed
          </label>
        </form>
      </div>
      <button className={`clearComplete clearComplete_${props.theme}`} onClick={clearComplete}>
        Clear Completed
      </button>
    </div>
  );
