...
function TaskList({todoList, setTodoList}) {
  ...
  function displayListType(listType){
    if(listType === "all"){
      <TaskItem displayList={[...todoList]} completeTask={completeTask} /> 
    } else if(listType === "active"){
      <TaskItem displayList={[...todoList].filter((todo)=> !todo.complete)} completeTask={completeTask} /> 
    } else {
      <TaskItem displayList={[...todoList].filter((todo) => todo.complete)} completeTask={completeTask} /> 
    }
  }
